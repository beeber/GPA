...
class Furniture {
  ...
  Furniture(PApplet parent) {
   ...
   String fileName;
    switch(myType) {
      case CHAIR: fileName = ChairName.get(int(random(0,4))); break;
      case TABLE: fileName = TableName.get(int(random(0,2))); break;
      case SOFA:  fileName = SofaName.get(int(random(0,2))); break;
      case SHELF: fileName = ShelfName.get(int(random(0,2))); break;
      case COFFEE_TABLE: fileName = CoffeeTableName.get(int(random(0,2)));
